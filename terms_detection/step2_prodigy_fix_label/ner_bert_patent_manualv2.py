...
def ner_manual_tokenizers_bert(
    ...
    model_checkpoint = "ktgiahieu/RoBERTa-large-PM-M3-Voc-hf-finetuned-ner-v2"
    ...
    label_list = ['B-Detailed_description','B-Lab_value','B-Medication','I-Detailed_description','I-Lab_value','I-Medication','O']
    ...
    stream = add_tokens(stream, count)
    return {
        "dataset": dataset,
        "stream": stream,
        "view_id": "ner_manual",
        "config": {
            ...
            "labels": ['Detailed_description','Lab_value','Medication'],
            "exclude_by": "input",
